...
apt-get -y install software-properties-common unattended-upgrades php8.3 php8.3-common php8.3-snmp php8.3-xml php8.3-zip php8.3-mbstring php8.3-curl php8.3-cgi php8.3-fpm php8.3-gd php8.3-imagick php8.3-intl php8.3-memcached php8.3-mysql php8.3-opcache php8.3-pgsql php8.3-redis nginx mysql-server certbot unzip dos2unix
...
sed -i 's/;cgi.fix_pathinfo=0/cgi.fix_pathinfo=1/gI' /etc/php/8.3/fpm/php.ini
sed -i 's/;extension=fileinfo/extension=fileinfo/gI' /etc/php/8.3/fpm/php.ini
sed -i 's/;extension=gd/extension=gd/gI' /etc/php/8.3/fpm/php.ini
sed -i 's/;extension=imap/extension=imap/gI' /etc/php/8.3/fpm/php.ini
sed -i 's/;extension=mbstring/extension=mbstring/gI' /etc/php/8.3/fpm/php.ini
sed -i 's/;extension=exif/extension=exif/gI' /etc/php/8.3/fpm/php.ini
sed -i 's/;extension=mysqli/extension=mysqli/gI' /etc/php/8.3/fpm/php.ini
sed -i 's/;extension=openssl/extension=openssl/gI' /etc/php/8.3/fpm/php.ini
sed -i 's/;extension=pdo_mysql/extension=pdo_mysql/gI' /etc/php/8.3/fpm/php.ini
sed -i 's/;extension=sockets/extension=sockets/gI' /etc/php/8.3/fpm/php.ini
...
ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'zheer';

    -   Flush Cache.
FLUSH PRIVILEGES;

    -   Create Database.
CREATE DATABASE zheer;
