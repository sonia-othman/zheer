        ...
        <div class="flex items-center w-full gap-4">
            ...
            <div class="flex flex-col justify-between flex-1">
                ...
                <div class="flex flex-wrap gap-2 mt-2">
                    <div class="px-3 py-1 text-sm text-blue-700 bg-blue-100 rounded-full whitespace-nowrap">
                        {{ value.split('\n')[0] }}
                    </div>
                    <div class="px-3 py-1 text-sm text-green-700 bg-green-100 rounded-full whitespace-nowrap">
                        {{ value.split('\n')[1] }}
                    </div>
                </div>
            </div>
